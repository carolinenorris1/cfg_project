    ...
    return (
        ...
        <div className="App">
            ...
            <form>
                ...
                <input value={runTimeInMinutes} onChange={event => setRunTimeInMinutes(event.target.value)} name="run_time" type="number" required></input>
                <label htmlFor="break_time">Break time (seconds)</label>
                <input value={breakTimeInSeconds} onChange={event => setBreakTimeInSeconds(event.target.value)} name="break_time" type="number" required></input>
                <label>
