...
import eyeAnimationSideToSide from "./eye-animation-side-to-side.gif";
import eyeAnimationLookingUp from "./eye-animation-looking-up.gif";
import windchimesSound from "./windchimes.mp3";
import cheeringCrowdSound from "./cheering-crowd.mp3";
